...
let MovieCreditsService = class MovieCreditsService {
    ...
    async getMovieCreditsShort(movie_id) {
        const url = `https://api.themoviedb.org/3/movie/${movie_id}/credits?language=pl-PL`;
        const headers = {
            headers: {
                accept: 'application/json',
...
exports.MovieCreditsService = MovieCreditsService;
exports.MovieCreditsService = MovieCreditsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService])
], MovieCreditsService);
//# sourceMappingURL=movie-credits.service.js.map